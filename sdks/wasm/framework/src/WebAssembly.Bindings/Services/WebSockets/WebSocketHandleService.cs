...
namespace WebAssembly.Services.WebSockets {
	/// <summary>
	/// Provides a WebSocketHandle implementation providing WebSocket services.
	/// </summary>
	public class WebSocketHandleService : IWebSocketHandleService {
		...
		public Task CloseOutputAsync (WebSocketCloseStatus closeStatus, string statusDescription, CancellationToken cancellationToken) => throw new NotImplementedException ();
		...
		protected static void ThrowOnInvalidState (WebSocketState state, params WebSocketState [] validStates)
		{
			...
			throw new WebSocketException (WebSocketError.InvalidState, $"Current state: {state} Valid state(s): {validStatesText}");
		}
